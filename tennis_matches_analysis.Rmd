...
colnames(winners) <- c("player_id", "name", "tour_id", "surface",  "age", 
                       "rank", "ace", "double_fault", "saved points", 
...
model_igraca <- lm(ace ~ train_data$surface + train_data$`1st serves made` + 
                     ...
                     train_data$`2nd serves won`+ train_data$`served games` , data = as.data.frame(train_data))
...
used_vars <- c("1st serves made", "1st serves won", "2nd serves won", 
               "double_fault", "served games")
...
Preciznost od oko 66% na skupu podataka od 6931 obzervacija. Ajmo sada opet provesti logističku regresiju, ali bez prethodno spomenutih varijabli:
